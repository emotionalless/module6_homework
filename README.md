# module6_homework
Здесь находятся решения к следующим заданиям Модуля 6:

1.На этот раз оформите решение в виде функции, постарайтесь дать этой функции корректное название, вызовите функцию, проанализируйте синтаксис.
